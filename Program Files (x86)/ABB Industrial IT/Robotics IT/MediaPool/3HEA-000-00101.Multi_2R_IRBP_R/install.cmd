...
#NO_OPTGAP
#
config -filename $BOOTPATH/EIO/IoKR_Drveio1.cfg -domain EIO
#
...
config -filename $BOOTPATH/MOC/EXT_FYZ01.cfg -domain MOC
config -filename $BOOTPATH/MOC/SEC_FYZ01.cfg.enc -domain MOC -internal
# IRBP Calib. package
# 1.0.5
#
...
#
copy -from $BOOTPATH/Code/IrbpR1Data.sys -to $HOME/ApplSys/Irbp1Data.sys
copy -from $BOOTPATH/Code/IrbpR1Prc.sys -to $HOME/ApplSys/Irbp1Prc.sys
copy -from $BOOTPATH/Code/IrbpR1Mnu.sys -to $HOME/ApplSys/Irbp1Mnu.sys
copy -from $BOOTPATH/Code/IrbpR1EEv.sys -to $HOME/ApplSys/Irbp1EEv.sys
