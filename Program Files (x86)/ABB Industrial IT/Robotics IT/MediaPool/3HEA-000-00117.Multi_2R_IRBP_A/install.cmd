...
config -filename $BOOTPATH/PROC/pApiCmdR11.cfg -domain PROC
config -filename $BOOTPATH/PROC/pApiCmdR21.cfg -domain PROC
#NO_OPTGAP
setvar -var 10 -value 0
getkey -id "GapMedia" -var 10 -strvar $ANSWER -errlabel NO_OPTGAP
...
config -filename $BOOTPATH/PROC/pApiCmdP11.cfg -domain PROC
#NO_OPTGAP
#
#
...
config -filename $BOOTPATH/SYS/sMug1Smp3.cfg -domain SYS
#
config -filename $BOOTPATH/EIO/Drveio_1.cfg -domain EIO
config -filename $BOOTPATH/EIO/Sim_irbp.cfg -domain EIO
config -filename $BOOTPATH/EIO/IoA_1_Drveio1.cfg -domain EIO
#
...
echo -text "Installing config file for drive unit T, M8DM1"
config -filename $RELEASE/robots/drv1_lib/drvcfg/EXT_DRIVE_8T_DM1.cfg -domain MOC -replace
...
config -filename $BOOTPATH/MOC/EXT_FYW01.cfg -domain MOC
config -filename $BOOTPATH/MOC/SEC_FYW01.cfg.enc -domain MOC -internal
#
# Installing OP
...
config -filename $BOOTPATH/SYS/stnindR211.cfg -domain SYS
config -filename $BOOTPATH/SYS/stnindP1.cfg -domain SYS
config -filename $BOOTPATH/SYS/stnindP111.cfg -domain SYS
#
...
#
copy -from $BOOTPATH/Code/IrbpA1Data.sys -to $HOME/ApplSys/Irbp1Data.sys
copy -from $BOOTPATH/Code/IrbpA1Prc.sys -to $HOME/ApplSys/Irbp1Prc.sys
copy -from $BOOTPATH/Code/IrbpA1Mnu.sys -to $HOME/ApplSys/Irbp1Mnu.sys
copy -from $BOOTPATH/Code/IrbpA1EEv.sys -to $HOME/ApplSys/Irbp1EEv.sys
