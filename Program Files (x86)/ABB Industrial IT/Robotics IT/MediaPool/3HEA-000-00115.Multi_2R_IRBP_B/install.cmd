...
config -filename $BOOTPATH/MOC/EXT_FYK01.cfg -domain MOC
config -filename $BOOTPATH/MOC/SEC_FYK01.cfg.enc -domain MOC -internal
# IRBP Calib. package
# 1.0.5
#
...
#
copy -from $BOOTPATH/Code/IrbpB1Data.sys -to $HOME/ApplSys/Irbp1Data.sys
copy -from $BOOTPATH/Code/IrbpB1Prc.sys -to $HOME/ApplSys/Irbp1Prc.sys
copy -from $BOOTPATH/Code/IrbpB1Mnu.sys -to $HOME/ApplSys/Irbp1Mnu.sys
copy -from $BOOTPATH/Code/IrbpB1EEv.sys -to $HOME/ApplSys/Irbp1EEv.sys
