...
#NO_OPTGAP
#
config -filename $BOOTPATH/EIO/IoKR_1ax_Drveio1.cfg -domain EIO
#
...
echo -text "Installing config file for drive unit T, M9DM1"
config -filename $RELEASE/robots/drv1_lib/drvcfg/EXT_DRIVE_9T_DM1.cfg -domain MOC -replace
config -filename $BOOTPATH/MOC/EXT_FYG01.cfg -domain MOC
config -filename $BOOTPATH/MOC/SEC_FYG01.cfg.enc -domain MOC -internal
# IRBP Calib. package
# 1.0.5
#
...
copy -from $BOOTPATH/Code/IrbpK1xData.sys -to $HOME/ApplSys/Irbp1Data.sys
copy -from $BOOTPATH/Code/IrbpK1xPrc.sys -to $HOME/ApplSys/Irbp1Prc.sys
copy -from $BOOTPATH/Code/IrbpK1xMnu.sys -to $HOME/ApplSys/Irbp1Mnu.sys
copy -from $BOOTPATH/Code/IrbpK1xEEv.sys -to $HOME/ApplSys/Irbp1EEv.sys
