...
config -filename $BOOTPATH/PROC/pGapTskMapR2.cfg -domain PROC -replace
config -filename $BOOTPATH/PROC/pApiStateR1.cfg -domain PROC
config -filename $BOOTPATH/PROC/pApiStateR2.cfg -domain PROC
config -filename $BOOTPATH/PROC/pApiCmdR12.cfg -domain PROC
config -filename $BOOTPATH/PROC/pApiCmdR22.cfg -domain PROC
#NO_OPTGAP
setvar -var 10 -value 0
getkey -id "GapMedia" -var 10 -strvar $ANSWER -errlabel NO_OPTGAP
config -filename $BOOTPATH/EIO/IoGapCr21.cfg -domain EIO
config -filename $BOOTPATH/PROC/pGapTskMapP13.cfg -domain PROC -replace
config -filename  $BOOTPATH/SYS/sGapP1.cfg -domain SYS -replace
config -filename $BOOTPATH/PROC/pApiStateP1.cfg -domain PROC
config -filename $BOOTPATH/PROC/pApiCmdP12.cfg -domain PROC
#NO_OPTGAP
#
#
config -filename $BOOTPATH/SYS/sPos1Tsk.cfg -domain SYS
setvar -var 10 -value 0
getkey -id "ArcWMedia" -var 10 -strvar $ANSWER -errlabel NO_AW_BASE
config -filename $BOOTPATH/SYS/sAwPos1Tsk.cfg -domain SYS
#NO_AW_BASE
# IRBP TASK 1 USING MOTION PLANNER 3
config -filename $BOOTPATH/SYS/sMug1Imp3.cfg -domain SYS
#
...
#NO_OPTGAP
#
config -filename $BOOTPATH/EIO/IoC_Drveio1.cfg -domain EIO
#
...
config -filename $BOOTPATH/MOC/EXT_FYT01.cfg -domain MOC
config -filename $BOOTPATH/MOC/SEC_FYT01.cfg.enc -domain MOC -internal
# IRBP Calib. package
# 1.0.5
#
...
config -filename $BOOTPATH/EIO/IoGapOpCrR2.cfg -domain EIO
#NO_OPTGAP
...
copy -from $BOOTPATH/Code/GpOpEEvR21.sys -to $HOME/ApplSys/GpOpEEvR2.sys
#NO_OPTGAP
...
config -filename $BOOTPATH/SYS/sOpR2.cfg -domain SYS
config -filename $BOOTPATH/SYS/sOpDrvR1.cfg -domain SYS
config -filename $BOOTPATH/SYS/sOpDrvR2.cfg -domain SYS
setvar -var 10 -value 0
getkey -id "GapMedia" -var 10 -strvar $ANSWER -errlabel NO_OPTGAP
config -filename $BOOTPATH/SYS/sOpDrvR1c.cfg -domain SYS
config -filename $BOOTPATH/SYS/sOpDrvR2c.cfg -domain SYS
config -filename $BOOTPATH/SYS/sOpDrvR1g.cfg -domain SYS
config -filename $BOOTPATH/SYS/sOpDrvR2g.cfg -domain SYS
#NO_OPTGAP
setvar -var 10 -value 0
getkey -id "GapMedia" -var 10 -strvar $ANSWER -errlabel NO_OPTGAP
config -filename $BOOTPATH/EIO/IoGapOpCrP1.cfg -domain EIO
#NO_OPTGAP
setvar -var 10 -value 0
getkey -id "GapMedia" -var 10 -strvar $ANSWER -errlabel NO_OPTGAP
copy -from $BOOTPATH/Code/GpOpEEvP11.sys -to $HOME/ApplSys/GpOpEEvP1.sys
#NO_OPTGAP
config -filename $BOOTPATH/SYS/sOpP1.cfg -domain SYS
config -filename $BOOTPATH/SYS/sOpDrvP1.cfg -domain SYS
setvar -var 10 -value 0
getkey -id "GapMedia" -var 10 -strvar $ANSWER -errlabel NO_OPTGAP
config -filename $BOOTPATH/SYS/sOpDrvP1c.cfg -domain SYS
config -filename $BOOTPATH/SYS/sOpDrvP1g.cfg -domain SYS
#NO_OPTGAP
#
...
config -filename $BOOTPATH/SYS/shjR2.cfg -domain SYS
config -filename $BOOTPATH/EIO/hjeioPR2.cfg -domain EIO
config -filename $BOOTPATH/EIO/hjeioR11.cfg -domain EIO
config -filename $BOOTPATH/EIO/hjeioR21.cfg -domain EIO
...
copy -from $BOOTPATH/Code/GoSafeDataR21.sys -to $HOME/ApplSys/ROB2/GoSafeData.sys
#
#
...
config -filename $BOOTPATH/SYS/stnindR2.cfg -domain SYS
...
config -filename $BOOTPATH/SYS/stnindR212.cfg -domain SYS
config -filename $BOOTPATH/SYS/stnindP1.cfg -domain SYS
config -filename $BOOTPATH/SYS/stnindP112.cfg -domain SYS
#
...
config -filename $BOOTPATH/SYS/sGapMainR2.cfg -domain SYS
config -filename $BOOTPATH/SYS/sPartAdvR1.cfg -domain SYS
config -filename $BOOTPATH/SYS/sPartAdvR2.cfg -domain SYS
config -filename $BOOTPATH/SYS/sGapMainP1.cfg -domain SYS
config -filename $BOOTPATH/SYS/sPartAdvP1.cfg -domain SYS
#
...
config -filename $BOOTPATH/SYS/sIrbpP1.cfg -domain SYS
#
copy -from $BOOTPATH/Code/IrbpC1Data.sys -to $HOME/ApplSys/Irbp1Data.sys
copy -from $BOOTPATH/Code/IrbpC1Prc.sys -to $HOME/ApplSys/Irbp1Prc.sys
copy -from $BOOTPATH/Code/IrbpC1Mnu.sys -to $HOME/ApplSys/Irbp1Mnu.sys
copy -from $BOOTPATH/Code/IrbpC1EEv.sys -to $HOME/ApplSys/Irbp1EEv.sys
config -filename $BOOTPATH/SYS/sIrbp1Pg.cfg -domain SYS
#NO_OPTGAP
#
...
setvar -var 10 -value 0
getkey -id "GapMedia" -var 10 -strvar $ANSWER -errlabel NO_OPTGAP
copy -from $BOOTPATH/Code/PartR2S1.mod -to $HOME/ApplSys/PartR2S1.mod
copy -from $BOOTPATH/Code/PartR2S2.mod -to $HOME/ApplSys/PartR2S2.mod
config -filename $BOOTPATH/SYS/sModRob2S1m.cfg -domain SYS
config -filename $BOOTPATH/SYS/sModRob2S2m.cfg -domain SYS
copy -from $BOOTPATH/Code/DynPartR2S1.mod -to $HOME/ApplSys/DynPartR2S1.mod
copy -from $BOOTPATH/Code/DynPartPrcR2S1.mod -to $HOME/DynPart/DynPartPrcR2S1.mod
copy -from $BOOTPATH/Code/DynPartR2S2.mod -to $HOME/ApplSys/DynPartR2S2.mod
copy -from $BOOTPATH/Code/DynPartPrcR2S2.mod -to $HOME/DynPart/DynPartPrcR2S2.mod
config -filename $BOOTPATH/SYS/sDynModRob2S1m.cfg -domain SYS
config -filename $BOOTPATH/SYS/sDynModRob2S2m.cfg -domain SYS
#NO_OPTGAP
setvar -var 10 -value 0
getkey -id "GapMedia" -var 10 -strvar $ANSWER -errlabel NO_OPTGAP
copy -from $BOOTPATH/Code/PartP1S1.mod -to $HOME/ApplSys/PartP1S1.mod
copy -from $BOOTPATH/Code/PartP1S2.mod -to $HOME/ApplSys/PartP1S2.mod
config -filename $BOOTPATH/SYS/sModPos1S1m.cfg -domain SYS
config -filename $BOOTPATH/SYS/sModPos1S2m.cfg -domain SYS
copy -from $BOOTPATH/Code/DynPartP1S1.mod -to $HOME/ApplSys/DynPartP1S1.mod
copy -from $BOOTPATH/Code/DynPartPrcP1S1.mod -to $HOME/DynPart/DynPartPrcP1S1.mod
copy -from $BOOTPATH/Code/DynPartP1S2.mod -to $HOME/ApplSys/DynPartP1S2.mod
copy -from $BOOTPATH/Code/DynPartPrcP1S2.mod -to $HOME/DynPart/DynPartPrcP1S2.mod
config -filename $BOOTPATH/SYS/sDynModPos1S1m.cfg -domain SYS
config -filename $BOOTPATH/SYS/sDynModPos1S2m.cfg -domain SYS
#NO_OPTGAP
#END_SCRIPT
