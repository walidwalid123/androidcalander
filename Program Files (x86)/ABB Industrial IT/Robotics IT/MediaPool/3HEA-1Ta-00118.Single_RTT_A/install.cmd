...
echo -text "Installing RTT config files ..."
...
config -filename $BOOTPATH/MOC/SEC_motty.cfg.enc -domain MOC -internal
config -filename $BOOTPATH/MOC/sec_FYLO21.cfg.enc -domain MOC -internal
config -filename $BOOTPATH/MOC/ext_FYLO21.cfg -domain MOC
#
# Installing OP
...
copy -from $BOOTPATH/Code/GoSafeDataR11t.sys -to $HOME/ApplSys/ROB1/GoSafeData.sys
#
#
