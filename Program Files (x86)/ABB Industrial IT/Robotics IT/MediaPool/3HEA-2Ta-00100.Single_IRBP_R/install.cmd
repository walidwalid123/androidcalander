...
setvar -var 10 -value 0
getkey -id "GapMedia" -var 10 -strvar $ANSWER -errlabel NO_OPTGAP
config -filename $BOOTPATH/EIO/IoGapCr11.cfg -domain EIO
config -filename $BOOTPATH/PROC/pGapTskMapP12.cfg -domain PROC -replace
...
#NO_AW_BASE
# IRBP TASK 1 USING MOTION PLANNER 2
config -filename $BOOTPATH/SYS/sMug1SImp2.cfg -domain SYS
#
