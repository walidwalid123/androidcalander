...
MODULE PartR1S2
  ...
  ! Written by:   SÖ
  !
  ! Description:  Module that holds the robot 1 program for station 2.
  !
  ! Procedures:   ProgStn2
  !
  ! Functions:    None
  ...
  !************************************************************
  !
  TASK PERS partdata pdProgStn2:=["ProgStn2","Program station 2","T_ROB1:T_POS1",2,0,"GapEmptyPart200.gif","pdvProgStn2"];
