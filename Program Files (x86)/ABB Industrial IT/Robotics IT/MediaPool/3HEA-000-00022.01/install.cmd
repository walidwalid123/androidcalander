...
echo -text " Disk : 3HEA-000-00000.1"
#
...
#
config -filename $BOOTPATH/EIO/IoBD.cfg -domain EIO
#
...
config -filename $BOOTPATH/MOC/EXT_FYF02.cfg -domain MOC
config -filename $BOOTPATH/MOC/SEC_FYF02.cfg.enc -domain MOC -internal
# IRBP Calib. package
# 1.0.5
#
